...
dataset = numpy.loadtxt("test_query_result.csv", skiprows=1, delimiter=",")
...
dataset_to_predict = numpy.loadtxt("test_to_check.csv", delimiter=",")
...
print("Num Claimed Predicted: {}").format(num_claimed_predicted)
print("# Actually Claimed: {}").format(num_actually_claimed)
print("Num Not Claimed Predicted: {}").format(num_not_claimed_predicted)
